...
$(document).ready(function () {
    ...
    $('#email').on('blur', function () {
        ...
        if (email === "") {
            ...
            emailError.text('Please use a Northeastern email');
        } else {
            emailError.text('');
        }
    ...
    $('#username').on('blur', function () {
        ...
        if (username === "") {
            ...
            usernameError.text('Special characters are not allowed');
    ...
    $('#loginButton').click(function () {
        // Redirect on login click; you may add your own logic
        window.location.href = '/calculator.html?name=' + $('#username').val();
        return false;
    });
});
