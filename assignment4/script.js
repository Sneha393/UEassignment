...
function createCheckboxes() {
            ...
            if (ratingvalue === "1") {
                ...
                createCheckbox("badfood", "Bad food");
                createCheckbox("badservice", "Bad Service");
				

            }
			else if(ratingvalue === "2") {
				createCheckbox("noambience", "No Ambience ");
				...
				createCheckbox("improveservice", "Improve service");
			}
